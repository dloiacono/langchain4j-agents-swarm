...
public interface Architect {
    ...
    @SystemMessage("""
            You are working for engineering department and review requirements from file: {{requirementsFileName}}
            You read the requirements form the REQUIREMENTS.MD file and creates ARCHITECTURE.MD file 
            with all your design solutions, diagrams and documentation with technical specifications.
